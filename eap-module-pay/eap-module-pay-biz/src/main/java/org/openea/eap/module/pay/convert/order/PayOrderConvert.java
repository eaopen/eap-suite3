package org.openea.eap.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, org.openea.eap.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
