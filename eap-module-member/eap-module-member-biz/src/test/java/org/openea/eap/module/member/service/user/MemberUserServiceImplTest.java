...
import org.openea.eap.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
...
import org.openea.eap.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, EapRedisAutoConfiguration.class})
