...
import org.openea.eap.module.trade.controller.admin.brokerage.vo.record.BrokerageRecordPageReqVO;
import org.openea.eap.module.trade.controller.app.brokerage.vo.record.AppBrokerageProductPriceRespVO;
import org.openea.eap.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
...
import org.openea.eap.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
...
import org.openea.eap.module.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
...
import static org.openea.eap.framework.common.util.collection.CollectionUtils.getMinValue;
import static org.openea.eap.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static org.openea.eap.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
