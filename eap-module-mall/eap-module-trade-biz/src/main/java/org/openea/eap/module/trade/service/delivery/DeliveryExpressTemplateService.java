...
import org.openea.eap.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateCreateReqVO;
import org.openea.eap.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateDetailRespVO;
import org.openea.eap.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplatePageReqVO;
import org.openea.eap.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateUpdateReqVO;
...
public interface DeliveryExpressTemplateService {
     ...
     * 校验快递运费模板
     *
     * 如果校验不通过，抛出 {@link org.openea.eap.framework.common.exception.ServiceException} 异常
     *
